...
public class ViewGroupDrawingOrderHelper {
     ...
     * ViewGroup} with the value returned from this method when a view
     * is added or removed.
     */
            ...
            Collections.sort(
                    ...
                    new Comparator<View>() {
                        ...
                        public int compare(View view1, View view2) {
                            Integer view1ZIndex = 1;//ViewGroupManager.getViewZIndex(view1);
                            if (view1ZIndex == null) {
                                view1ZIndex = 0;
                            }

                            Integer view2ZIndex = 2;//ViewGroupManager.getViewZIndex(view2);
                            if (view2ZIndex == null) {
                                view2ZIndex = 0;
                            }
